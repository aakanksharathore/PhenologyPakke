...
#Load data
dat1 = read.csv("2011 to 2017- checked and corrected.csv")
str(dat1)
#Clean-up data
dat1 = na.omit(dat1)
#Remove figs and individuals for which less than 4 trees are available and dead trees
countT=table(dat1$Scientific.name[dat1$Year=="2011" & dat1$Month=="Jan"])
dat =dat1[-which(((dat1$Scientific.name %in% names(which(countT<4))) | (dat1$Dead==1) | dat1$Fruit.type=="Fig")),]
##dat=dat[dat$Dispersalmode=="Mammal-dispersed",]
...
png("Graphs//CorrYsh_TR.png",width=1080,height=720,units = "px", pointsize = 20)
...
png("Graphs//CorrYsh_TS.png",width=1080,height=720,units = "px", pointsize = 20)
...
png("Graphs//CorrYsh_Tmin.png",width=1080,height=720,units = "px", pointsize = 20)
...
png("Graphs//CorrYsh_Tmax.png",width=1080,height=720,units = "px", pointsize = 20)
...
png("Graphs//CorrYsh_DL.png",width=1080,height=720,units = "px", pointsize = 20)
